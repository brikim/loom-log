...
namespace warp
{
   ...
   public:
      ...
      [[nodiscard]] std::optional<PlexSearchResults> GetItemInfoByPath(std::string_view userToken, const std::filesystem::path& filePath);
      ...
      bool SetPlayed(std::string_view userToken, std::string_view ratingKey, int64_t locationMs);
      bool SetWatched(std::string_view userToken, std::string_view ratingKey);
